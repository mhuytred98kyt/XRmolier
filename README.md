...
* **务必替换所有的`8f91b6a0-e8ee-11ea-adc1-0242ac120002`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 路径：/8f91b6a0-e8ee-11ea-adc1-0242ac120002-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 插件选项: tls;host=xxx.herokuapp.com;path=/8f91b6a0-e8ee-11ea-adc1-0242ac120002-ss
```
</details>
